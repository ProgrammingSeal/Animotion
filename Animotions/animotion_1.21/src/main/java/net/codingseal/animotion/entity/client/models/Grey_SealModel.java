...
import net.codingseal.animotion.entity.client.animations.Grey_SealAnimations;
...
public class Grey_SealModel<T extends Grey_SealEntity> extends SinglePartEntityModel<T> {
    ...
    public Grey_SealModel(ModelPart root) {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData nose = head.addChild("nose", ModelPartBuilder.create().uv(54, 64).cuboid(-2.0F, -3.0F, 2.0F, 3.0F, 2.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
    ...
    @Override
    public void setAngles(Grey_SealEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
