...
public class Tiger_SharkEntity extends PathAwareEntity {
    ...
    private static final TrackedData<Integer> DATA_ID_TYPE_VARIANT =
            DataTracker.registerData(Tiger_SharkEntity.class, TrackedDataHandlerRegistry.INTEGER);
...
private void setupAnimationStates() {
    ...
    public Tiger_SharkVariant getVariant() {
        return Tiger_SharkVariant.byId(this.getTypeVariant() & 255);
    }
    private int getTypeVariant() {
        return this.dataTracker.get(DATA_ID_TYPE_VARIANT);
    }
    private void setVariant(Tiger_SharkVariant variant) {
