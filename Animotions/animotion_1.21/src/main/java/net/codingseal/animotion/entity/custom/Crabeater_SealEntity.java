...
public class Crabeater_SealEntity extends AnimalEntity {
    ...
    private static final TrackedData<Integer> DATA_ID_TYPE_VARIANT =
            DataTracker.registerData(Crabeater_SealEntity.class, TrackedDataHandlerRegistry.INTEGER);

    public Crabeater_SealEntity(EntityType<? extends AnimalEntity> entityType, World world) {
    ...
    public PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
        Crabeater_SealEntity baby = ModEntities.CRABEATER_SEAL.create(world);
        Crabeater_SealVariant variant = Util.getRandom(Crabeater_SealVariant.values(), this.random);
    ...
    public Crabeater_SealVariant getVariant() {
        return Crabeater_SealVariant.byId(this.getTypeVariant() & 255);
    }
    private int getTypeVariant() {
        return this.dataTracker.get(DATA_ID_TYPE_VARIANT);
    }
    private void setVariant(Crabeater_SealVariant variant) {
