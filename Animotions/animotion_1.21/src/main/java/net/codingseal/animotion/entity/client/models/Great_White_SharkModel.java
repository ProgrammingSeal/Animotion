...
import net.codingseal.animotion.entity.client.animations.Great_White_SharkAnimations;
...
public class Great_White_SharkModel<T extends Great_White_SharkEntity> extends SinglePartEntityModel<T> {
    public static final EntityModelLayer GREAT_WHITE_SHARK = new EntityModelLayer(Identifier.of(Animotion.MOD_ID, "great_white_shark"), "main");
	...
	public Great_White_SharkModel(ModelPart root) {
    ...
    @Override
    public void setAngles(Great_White_SharkEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.getPart().traverse().forEach(ModelPart::resetTransform);
        this.setHeadAngles(netHeadYaw, headPitch);

        this.animateMovement(Great_White_SharkAnimations.IDLE,  limbSwing, limbSwingAmount, 2f, 2.5f );
        this.updateAnimation(entity.idleAnimationState, Great_White_SharkAnimations.IDLE, ageInTicks, 1f);
        // V0.0.4
        this.updateAnimation(entity.swimAnimationState, Great_White_SharkAnimations.SWIM, ageInTicks);
