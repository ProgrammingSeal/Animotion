...
public class Grey_SealEntity extends AnimalEntity {
    ...
    private static final TrackedData<Integer> DATA_ID_TYPE_VARIANT =
            DataTracker.registerData(Grey_SealEntity.class, TrackedDataHandlerRegistry.INTEGER);

    public Grey_SealEntity(EntityType<? extends AnimalEntity> entityType, World world) {
    ...
    public PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
        Grey_SealEntity baby = ModEntities.GREY_SEAL.create(world);
        Grey_SealVariant variant = Util.getRandom(Grey_SealVariant.values(), this.random);
    ...
    public Grey_SealVariant getVariant() {
        return Grey_SealVariant.byId(this.getTypeVariant() & 255);
    }
    private int getTypeVariant() {
        return this.dataTracker.get(DATA_ID_TYPE_VARIANT);
    }
    private void setVariant(Grey_SealVariant variant) {
