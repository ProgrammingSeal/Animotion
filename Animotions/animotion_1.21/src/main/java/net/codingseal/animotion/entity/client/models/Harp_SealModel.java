...
import net.codingseal.animotion.entity.client.animations.Harp_SealAnimations;
...
public class Harp_SealModel<T extends Harp_SealEntity> extends SinglePartEntityModel<T> {
    ...
    public Harp_SealModel(ModelPart root) {
    ...
    @Override
    public void setAngles(Harp_SealEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
