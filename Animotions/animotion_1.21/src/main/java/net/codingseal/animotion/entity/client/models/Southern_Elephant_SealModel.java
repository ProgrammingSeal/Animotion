...
import net.codingseal.animotion.entity.client.animations.Southern_Elephant_SealAnimations;
...
public class Southern_Elephant_SealModel<T extends Southern_Elephant_SealEntity> extends SinglePartEntityModel<T> {
    ...
    public Southern_Elephant_SealModel(ModelPart root) {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData nose = head.addChild("nose", ModelPartBuilder.create().uv(54, 64).cuboid(-2.0F, -5.0F, 3.0F, 3.0F, 3.0F, 1.0F, new Dilation(0.0F))
                .uv(62, 64).cuboid(-2.0F, -6.0F, 4.0F, 3.0F, 3.0F, 1.0F, new Dilation(0.0F))
                .uv(66, 52).cuboid(-2.0F, -6.0F, 6.0F, 3.0F, 3.0F, 1.0F, new Dilation(0.0F))
                .uv(66, 56).cuboid(-2.0F, -7.0F, 5.0F, 3.0F, 3.0F, 1.0F, new Dilation(0.0F))
                .uv(66, 60).cuboid(-2.0F, -5.0F, 5.0F, 3.0F, 3.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
        ...
        ModelPartData rearflipper_left_r1 = rear_flipper_left.addChild("rearflipper_left_r1", ModelPartBuilder.create().uv(0, 56).cuboid(-1.0F, -1.0F, -2.0F, 2.0F, 1.0F, 7.0F, new Dilation(0.0F)), ModelTransform.of(4.0F, -1.0F, -22.0F, 0.0F, -0.5236F, 0.0F));
        ...
        ModelPartData rear_flipper_right_r1 = rear_flipper_right.addChild("rear_flipper_right_r1", ModelPartBuilder.create().uv(18, 56).cuboid(-1.0F, -1.0F, -2.0F, 2.0F, 1.0F, 7.0F, new Dilation(0.0F)), ModelTransform.of(-3.0F, -1.0F, -22.0F, 0.0F, 0.5236F, 0.0F));
    ...
    @Override
    public void setAngles(Southern_Elephant_SealEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
