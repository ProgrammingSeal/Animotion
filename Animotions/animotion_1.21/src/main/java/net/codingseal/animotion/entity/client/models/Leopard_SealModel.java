...
import net.codingseal.animotion.entity.client.animations.Leopard_SealAnimations;
...
public class Leopard_SealModel<T extends Leopard_SealEntity> extends SinglePartEntityModel<T> {
    ...
    public Leopard_SealModel(ModelPart root) {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData nose = head.addChild("nose", ModelPartBuilder.create().uv(64, 36).cuboid(-2.0F, -3.0F, 3.0F, 3.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
    ...
    @Override
    public void setAngles(Leopard_SealEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
