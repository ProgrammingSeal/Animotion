...
public class Leopard_SealEntity extends AnimalEntity {
    ...
    public Leopard_SealEntity(EntityType<? extends AnimalEntity> entityType, World world) {
    ...
    public PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
        Leopard_SealEntity baby = ModEntities.LEOPARD_SEAL.create(world);
        Leopard_SealVariant variant = Util.getRandom(Leopard_SealVariant.values(), this.random);
