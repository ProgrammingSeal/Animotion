...
import net.codingseal.animotion.entity.client.animations.Baikal_SealAnimations;
...
public class Baikal_SealModel<T extends Baikal_SealEntity> extends SinglePartEntityModel<T> {
    public static final EntityModelLayer BAIKAL_SEAL = new EntityModelLayer(Identifier.of(Animotion.MOD_ID, "baikal_seal"), "main");

    private final ModelPart root;
    private final ModelPart seal;
    private final ModelPart head;

    public Baikal_SealModel(ModelPart root) {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData skull = head.addChild("skull", ModelPartBuilder.create().uv(40, 52).cuboid(-4.0F, -6.0F, -3.0F, 7.0F, 6.0F, 6.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData nose = head.addChild("nose", ModelPartBuilder.create().uv(54, 17).cuboid(-2.0F, -3.0F, 3.0F, 3.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
        ...
        ModelPartData front_flipper_right_2_r1 = front_flipper_right_base_1.addChild("front_flipper_right_2_r1", ModelPartBuilder.create().uv(16, 64).cuboid(-3.0F, -1.0F, -1.0F, 5.0F, 1.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(10.9522F, -2.1674F, 0.2718F, 0.0873F, 0.0F, -0.4363F));
        ...
        ModelPartData front_flipper_right_1_r1 = front_flipper_right_base_2.addChild("front_flipper_right_1_r1", ModelPartBuilder.create().uv(18, 60).cuboid(-5.0F, -1.0F, -2.0F, 6.0F, 1.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(-0.0478F, -0.1674F, 0.2718F, 0.0865F, -0.0114F, 0.1304F));
        ...
        ModelPartData front_flipper_left_r1 = front_flipper_left_base_1.addChild("front_flipper_left_r1", ModelPartBuilder.create().uv(18, 56).cuboid(-6.0F, -1.0F, -1.0F, 7.0F, 1.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(1.3741F, -0.4499F, 0.4526F, 0.0645F, 0.0039F, -0.0753F));
        ...
        ModelPartData front_flipper_left_2_r1 = front_flipper_left_base_2.addChild("front_flipper_left_2_r1", ModelPartBuilder.create().uv(0, 64).cuboid(-4.0F, -1.0F, -1.0F, 5.0F, 1.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(-1.6259F, -0.4499F, -0.5474F, 0.0436F, 0.0F, 0.3927F));
        ...
        ModelPartData rearflipper_left_r1 = rear_flipper_left.addChild("rearflipper_left_r1", ModelPartBuilder.create().uv(54, 9).cuboid(-1.0F, -1.0F, -2.0F, 2.0F, 1.0F, 7.0F, new Dilation(0.0F)), ModelTransform.of(4.0F, -1.0F, -22.0F, 0.0F, -0.5236F, 0.0F));
        ...
        ModelPartData rear_flipper_right_r1 = rear_flipper_right.addChild("rear_flipper_right_r1", ModelPartBuilder.create().uv(0, 56).cuboid(-1.0F, -1.0F, -2.0F, 2.0F, 1.0F, 7.0F, new Dilation(0.0F)), ModelTransform.of(-3.0F, -1.0F, -22.0F, 0.0F, 0.5236F, 0.0F));
        ...
        ModelPartData upper_body_base_2_v3 = upper_body_base_2.addChild("upper_body_base_2_v3", ModelPartBuilder.create().uv(54, 0).cuboid(-6.0F, -7.0F, -7.0F, 11.0F, 6.0F, 3.0F, new Dilation(0.0F)), ModelTransform.pivot(-14.0F, -1.0F, 17.0F));
    ...
    @Override
    public void setAngles(Baikal_SealEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
